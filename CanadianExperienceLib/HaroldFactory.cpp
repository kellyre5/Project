...
std::shared_ptr<Actor> HaroldFactory::Create(std::wstring imagesDir)
{
    ...
    auto hat = std::make_shared<ImageDrawable>(L"Fancy Hat", imagesDir + L"/fancy-hat-sized.png");
    hat->SetCenter(wxPoint(125, 75));
    hat->SetPosition(wxPoint(0, -102));
    headt->AddChild(hat);
